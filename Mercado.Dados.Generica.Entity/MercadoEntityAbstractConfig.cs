...
namespace Mercado.Dados.Generica.Entity
{
    public abstract class MercadoEntityAbstractConfig<TEntidade> : EntityTypeConfiguration<TEntidade>
        where TEntidade : class
    {
        public MercadoEntityAbstractConfig()
        {
